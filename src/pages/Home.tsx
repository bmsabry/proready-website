...
const team: TeamMember[] = [
  ...
  },
  {
    ...
    bio: "Dr. Zaeem Khan is a specialist in high-fidelity thermal and structural Finite Element Analysis (FEA), who helps engineering firms and startups through the hard parts of product development. With a career spanning the automotive industry, R&D at the GE Global Research Center, and the successful leadership of an NSF-funded startup, Dr. Khan brings a whole-product perspective to every project. He goes beyond the numbers to consider the variables that truly dictate a product's success: material cost, manufacturing feasibility, and long-term durability. By developing custom tools and macros, Dr. Khan delivers rapid, error-free analysis grounded in the latest analytical methods. Whether you are validating a new concept or diagnosing a failure in an existing design, he provides the data-driven clarity needed to reduce time-to-market and ensure structural integrity.",
    image: "/Zaeem.jpg"
  },
  {
    name: "Mohamed Bakr",
    role: "Static Equipment & Pressure Vessel Design Expert",
    bio: `Mohamed Bakr is a Senior Engineering Manager and a recognized authority in Static Equipment and Pressure Vessel Design. With over 20 years of experience, he specializes in the detailed design of piping systems and static equipment for complex Oil & Gas projects. Mohamed's expertise covers the entire project lifecycle, from initial concept and advanced 2D/3D modeling through detailed engineering, material take-off, and final commissioning.
