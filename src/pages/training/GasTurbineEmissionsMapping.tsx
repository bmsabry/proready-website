...
const CURRICULUM: Day[] = [
  {
    ...
    chapters: 'Chapters 1–2 · 56 slides',
    summary:
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8 mt-4">
            {[
              ...
              },
              {
                ...
                body: 'All 228 slides across the four days, in your own browser account, so you can review any chapter long after the live sessions end.',
              },
              {
